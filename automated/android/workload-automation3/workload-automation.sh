...
AGENDA="http://build4.baylibre.com/var/www/html/lava/Agenda/testsuites/peripheral_i350-evk.yaml" #"agenda/generic-dhrystone.yaml"
PLUGIN="http://build4.baylibre.com/var/www/html/lava/Plugin_wa/bl_plugins-0.0.1.tar.gz"
